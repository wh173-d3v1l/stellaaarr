...
const Lang = Language.getString('_DrkBot');

if (Config.WORKTYPE == 'private') {

    DrkBot.addCommand({pattern: 'botprivate ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    DrkBot.addCommand({pattern: 'botpublic ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
