...
DrkBot.addCommand({pattern: 'filter ?(.*)', fromMe: true, desc: Lang.FILTER_DESC}, (async (message, match) => {
...
DrkBot.addCommand({pattern: 'stop ?(.*)', fromMe: true, desc: Lang.STOP_DESC}, (async (message, match) => {
...
DrkBot.addCommand({on: 'text', fromMe: true}, (async (message, match) => {
